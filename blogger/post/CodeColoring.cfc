<cfcomponent output="no">
	<!---
		...
		March 9, 2009, Paul Klinkenberg, www.leeftpaulnog.nl
		...
		April 14, 2009, Paul Klinkenberg, www.leeftpaulnog.nl
	...
	<cffunction name="colorFile" output="false" returntype="string" access="public">
		...
		<cfargument name="useCaching" type="boolean" default="false" />
